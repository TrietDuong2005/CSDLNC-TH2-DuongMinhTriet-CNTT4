...
CREATE TABLE REGIONS (
    REGION_ID NUMBER CONSTRAINT REGIONS_ID_PK PRIMARY KEY, 
    REGION_NAME VARCHAR2(25)
);

CREATE TABLE COUNTRIES (
    COUNTRY_ID CHAR(2) CONSTRAINT COUNTRIES_ID_PK PRIMARY KEY, 
    COUNTRY_NAME VARCHAR2(40), 
    REGION_ID NUMBER CONSTRAINT COUNTRIES_REG_FK REFERENCES REGIONS(REGION_ID)
);

CREATE TABLE LOCATIONS (
    LOCATION_ID NUMBER(4) CONSTRAINT LOCATIONS_ID_PK PRIMARY KEY, 
    STREET_ADDRESS VARCHAR2(100), 
    CITY VARCHAR2(30), 
    STATE_PROVINCE VARCHAR2(25), 
    POSTAL_CODE VARCHAR2(12), 
    COUNTRY_ID CHAR(2) CONSTRAINT LOCATIONS_COU_FK REFERENCES COUNTRIES(COUNTRY_ID)
);

CREATE TABLE DEPARTMENTS (
    DEPARTMENT_ID NUMBER(4) CONSTRAINT DEPARTMENTS_ID_PK PRIMARY KEY, 
    DEPARTMENT_NAME VARCHAR2(30), 
    MANAGER_ID NUMBER(6), 
    LOCATION_ID NUMBER(4) CONSTRAINT DEPARTMENTS_LOC_FK REFERENCES LOCATIONS(LOCATION_ID)
);

CREATE TABLE JOBS (
    JOB_ID VARCHAR2(10) CONSTRAINT JOBS_ID_PK PRIMARY KEY, 
...
CREATE TABLE EMPLOYEES (
    EMPLOYEE_ID NUMBER(6) CONSTRAINT EMPLOYEES_ID_PK PRIMARY KEY, 
    FIRST_NAME VARCHAR2(20), 
    LAST_NAME VARCHAR2(25), 
    EMAIL VARCHAR2(25), 
    PHONE_NUMBER VARCHAR2(20), 
    HIRE_DATE DATE, 
    JOB_ID VARCHAR2(10) CONSTRAINT EMPLOYEES_JOB_FK REFERENCES JOBS(JOB_ID), 
    SALARY NUMBER(11,2), 
    COMMISSION_PCT NUMBER(4,2), 
    MANAGER_ID NUMBER(6) CONSTRAINT EMPLOYEES_MGR_FK REFERENCES EMPLOYEES(EMPLOYEE_ID), 
    DEPARTMENT_ID NUMBER(4) CONSTRAINT EMPLOYEES_DEPT_FK REFERENCES DEPARTMENTS(DEPARTMENT_ID)
);
...
CREATE TABLE JOB_HISTORY (
    ...
    CONSTRAINT JHIST_ID_DATE_PK PRIMARY KEY (EMPLOYEE_ID, START_DATE)
);

ALTER TABLE DEPARTMENTS ADD CONSTRAINT DEPT_MGR_FK FOREIGN KEY (MANAGER_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID);

INSERT INTO REGIONS VALUES (1, 'Châu Á');
INSERT INTO REGIONS VALUES (2, 'Châu Âu');
INSERT INTO REGIONS VALUES (3, 'Châu Mỹ');

INSERT INTO COUNTRIES VALUES ('VN', 'Việt Nam', 1);
INSERT INTO COUNTRIES VALUES ('CA', 'Canada', 3);
INSERT INTO COUNTRIES VALUES ('US', 'Hoa Kỳ', 3);
INSERT INTO COUNTRIES VALUES ('UK', 'Anh Quốc', 2);

INSERT INTO LOCATIONS VALUES (1500, 'Tòa nhà Bitexco, Quận 1', 'San Francisco', 'California', '700000', 'US');
INSERT INTO LOCATIONS VALUES (1700, 'Tòa nhà Keangnam, Nam Từ Liêm', 'Hà Nội', 'Miền Bắc', '100000', 'VN');
INSERT INTO LOCATIONS VALUES (1800, 'Khu người Việt', 'Toronto', 'Ontario', '550000', 'CA');

INSERT INTO DEPARTMENTS VALUES (10, 'Hành Chính Nhân Sự', NULL, 1700);
INSERT INTO DEPARTMENTS VALUES (20, 'Nghiên Cứu Phát Triển', NULL, 1800);
INSERT INTO DEPARTMENTS VALUES (50, 'Kho Vận Hậu Cần', NULL, 1500);
INSERT INTO DEPARTMENTS VALUES (80, 'Kinh Doanh Tiếp Thị', NULL, 1700);
INSERT INTO DEPARTMENTS VALUES (90, 'Hội Đồng Quản Trị', NULL, 1700);
INSERT INTO DEPARTMENTS VALUES (500, 'Bộ Phận Khởi Nghiệp', NULL, 1700);

INSERT INTO JOBS VALUES ('AD_PRES', 'Tổng Giám Đốc', 50000, 100000);
INSERT INTO JOBS VALUES ('AD_VP', 'Phó Giám Đốc', 30000, 60000);
INSERT INTO JOBS VALUES ('SA_MAN', 'Trưởng Phòng Kinh Doanh', 15000, 30000);
INSERT INTO JOBS VALUES ('SA_REP', 'Chuyên Viên Kinh Doanh', 6000, 15000);
INSERT INTO JOBS VALUES ('ST_CLERK', 'Nhân Viên Kho', 2000, 10000);
INSERT INTO JOBS VALUES ('IT_PROG', 'Lập Trình Viên', 4000, 25000);

INSERT INTO EMPLOYEES VALUES (100, 'Nguyễn Trọng', 'King', 'NKING', '0901234567', TO_DATE('17/06/1987', 'DD/MM/YYYY'), 'AD_PRES', 60000, NULL, NULL, 90);
INSERT INTO EMPLOYEES VALUES (101, 'Dương', 'Triết', 'DTRIET', '0987654321', TO_DATE('15/05/1986', 'DD/MM/YYYY'), 'AD_VP', 45000, NULL, 100, 90);
INSERT INTO EMPLOYEES VALUES (149, 'Trần Tuấn', 'Zlotkey', 'TZLOTKEY', '0912345678', TO_DATE('29/01/1994', 'DD/MM/YYYY'), 'SA_MAN', 15000, 0.2, 100, 80);
INSERT INTO EMPLOYEES VALUES (151, 'Lê Tiến', 'Davies', 'LDAVIES', '0934567890', TO_DATE('29/01/1997', 'DD/MM/YYYY'), 'ST_CLERK', 4000, NULL, 100, 50);
INSERT INTO EMPLOYEES VALUES (3, 'Phạm Văn', 'Doãn', 'PDOAN', '0945678901', TO_DATE('01/01/1990', 'DD/MM/YYYY'), 'IT_PROG', 8000, NULL, 100, 50);
INSERT INTO EMPLOYEES VALUES (102, 'Gia', 'Nguyễn', 'GNGUYEN', '0978123456', TO_DATE('25/06/1994', 'DD/MM/YYYY'), 'IT_PROG', 800, NULL, 100, 50);
INSERT INTO EMPLOYEES VALUES (103, 'Thị Lan', 'Phan', 'LPHAN', '0989123456', TO_DATE('25/03/1998', 'DD/MM/YYYY'), 'SA_REP', 5000, 0.15, 149, 80);
INSERT INTO EMPLOYEES VALUES (104, 'Thanh', 'Lê Anh', 'TLEANH', '0909112233', TO_DATE('17/08/1996', 'DD/MM/YYYY'), 'ST_CLERK', 4000, NULL, 100, 20);
INSERT INTO EMPLOYEES VALUES (105, 'Trúc', 'Mai', 'TMAI', '0918223344', TO_DATE('10/10/1997', 'DD/MM/YYYY'), 'ST_CLERK', 3500, NULL, 100, 20);
INSERT INTO EMPLOYEES VALUES (106, 'Tiến', 'Đạt', 'TDAT', '0922334455', TO_DATE('15/06/1995', 'DD/MM/YYYY'), 'IT_PROG', 9000, NULL, 100, 50);
